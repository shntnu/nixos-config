...
- [Evaluate Zvec-Grep on a NixOS lab server](./docs/zvec-grep-evaluation.md) - measured runtime, retrieval behavior, resource use, packaging risks, and a capability and operational comparison with the existing QMD deployment
